...
def plot_comparison(protocols, delivery_data, overhead_data, latency_data, drop_data):
    ...
    # Simpan hasil plot
    output_filename = "hasil_skripsi/test_1/Helsinki/energy/test3/Energy_Chart.png"
...
if __name__ == "__main__":
    ...
    report_files = {
        "ORQLCI": "hasil_skripsi/test_1\Helsinki\energy/test3/ORQLCI_ShortestMap_Optimized_MessageStatsReport.txt",
        "Epidemic": "hasil_skripsi/test_1\Helsinki\energy/test3/Epidemic_Helsinki_EnergyAware_MessageStatsReport.txt",
        "Prophet": "hasil_skripsi/test_1\Helsinki\energy/test3/Prophet_Helsinki_EnergyAware_MessageStatsReport.txt",
    }
