...
/**
 * Energy-aware variant of ProphetRouter for fair comparison with CCRouting (ORQLCI).
 *
 * Routing logic: IDENTICAL to ProphetRouter (delivery predictability, transitivity,
 *   GRTRMax forwarding — completely untouched).
 ...
 *
 * Config namespace: ProphetEnergyRouter (for energy params)
 *   ProphetEnergyRouter.initialEnergy  = 1000
 *   ProphetEnergyRouter.scanEnergy     = 0.1
 *   ProphetEnergyRouter.transmitEnergy = 0.5
 *   ProphetEnergyRouter.receiveEnergy  = 0.1
 *
 * PRoPHET params still under ProphetRouter namespace (unchanged):
 *   ProphetRouter.secondsInTimeUnit = 30
 *   ProphetRouter.beta = 0.25
 */
public class ProphetEnergyRouter extends ProphetRouter {

    private static final String NS = "ProphetEnergyRouter";
    ...
    public ProphetEnergyRouter(Settings s) {
        super(s);
    ...
    protected ProphetEnergyRouter(ProphetEnergyRouter r) {
        super(r);
    ...
    public void update() {
        ...
        // PRoPHET routing logic — completely unchanged
        super.update();
    }

    @Override
    public MessageRouter replicate() {
        return new ProphetEnergyRouter(this);
    }
